...
void main() {
  runApp(factsAdvanced());
}

class factsAdvanced extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Fact Advanced',
      theme: ThemeData(primarySwatch: Colors.orange),
      home: FactsAdvancedScreen(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class FactsAdvancedScreen extends StatefulWidget {
  @override
  _FactsAdvancedScreenState createState() => _FactsAdvancedScreenState();
}

class _FactsAdvancedScreenState extends State<FactsAdvancedScreen> {
