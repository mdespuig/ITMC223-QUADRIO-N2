              ...
              children: [
                ...
                Align(
                  ...
                  child: GestureDetector(
                    ...
                    child: Text(
                      "Forgot Password?",
                      style: TextStyle(color: Colors.blue, fontSize: 16, fontFamily: 'Montserrat'),
                    ),
                  ),
                ),
                SizedBox(height: 20),
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Or sign in with",
                        style: TextStyle(color: Colors.orange, fontFamily: 'Montserrat'),
                      ),
                    ),
                    Expanded(child: Divider(color: Colors.orange)),
                  ],
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      "Google",
                      style: TextStyle(color: Colors.orange, fontSize: 18, fontFamily: 'Montserrat'),
                    ),
                  ),
                ),
                SizedBox(height: 20),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Text(
                          "Sign up here",
                          style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontFamily: 'Montserrat'),
                        ),
                      ),
                    ],
                  ),
