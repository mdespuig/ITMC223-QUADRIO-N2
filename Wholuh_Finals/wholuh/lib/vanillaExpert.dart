        ...
        if (guess == selectedAnimal.toLowerCase()) {
          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content: Text('You have used all your attempts! The correct answer was $selectedAnimal.', style: TextStyle(fontFamily: 'Montserrat')),
              actions: [
                TextButton(
                  onPressed: () => Navigator.of(context).pop(),
                  child: Text('OK', style: TextStyle(fontFamily: 'Montserrat')),
          ...
          child: Column(
            children: [
              ...
              Text(
                ...
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.red, fontFamily: 'Montserrat'),
                textAlign: TextAlign.center,
              ),
              SizedBox(height: 20),
              Text(
