...
class advVanilla extends State<Vanilla_adv> {
  ...
  Future<void> loadSelection() async {
    ...
    setState(() {
      ...
      selectedAnimal = prefs.getString('vanillaAdvancedAnimal') ?? 'No animal selected';
    });
  }
        ...
        if (guess == selectedAnimal.toLowerCase()) {
          ...
          if (remainingGuesses == 0) {
            ...
            showDialog(
              context: context,
              builder: (context) => AlertDialog(
                title: Text('Game Over', style: TextStyle(fontFamily: 'Montserrat', fontWeight: FontWeight.bold)),
                content: Text('You have used all your guesses! The correct answer was $selectedAnimal.', style: TextStyle(fontFamily: 'Montserrat')),
                actions: [
                  TextButton(
                    onPressed: () => Navigator.of(context).pop(),
                    child: Text('OK', style: TextStyle(fontFamily: 'Montserrat')),
