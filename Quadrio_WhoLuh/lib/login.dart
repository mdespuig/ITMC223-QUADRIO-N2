...
/* 
  ...
  Company: Quadr.io
  Project: Who?/Luh!
  Feature: [WL-006]: Sign-in/Sign-up Page (Updated with role checking)
...
class _LoginRegisteredScreenState extends State<LoginRegisteredScreen> {
  ...
  final TextEditingController _passwordController = TextEditingController(); // Not really used here but you have it
